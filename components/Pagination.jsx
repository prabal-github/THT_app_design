...
export function Pagination({}) {
  return <nav aria-label="Page navigation example" className='mb-10 flex items-center justify-center'>
        <ul className="inline-flex -space-x-px">
          ...
          <li>
            <a href="#" aria-current="page" className="px-3 py-2 text-blue-600 border border-gray-300 bg-purple-100 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
          </li>
          <li>
